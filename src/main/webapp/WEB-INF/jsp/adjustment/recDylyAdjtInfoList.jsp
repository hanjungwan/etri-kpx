 ...
 *      수정일                                       수정자                                                  수정내용
 *  -------------        -----------       -------------------------
 *  2016. 11. 2.          creme55          최초생성 (REC일일정산 조회)
 *
 * </pre>
 **/
%>
...
<body>
					...
					<div class="contents" >
						<div class="title">REC 일일 정산
							<div class="location">
								...
								<img src="/images/img/ico_arr.png"><a href="javascript:;" onclick="javascript:goRecDylyAdjtInfoList(); return false;">REC 일일 정산</a></div>
						</div>
						
						<!---//search---->
						<div class="select_wrap">
							<form name="recDylyAdjtLstFrm" id="recDylyAdjtLstFrm" method="POST" enctype="multipart/form-data" action="">
								<div class="form-group">
									...
									<div class="bn"><a href="javascript:;" onclick="javascript:searchRecDylyAdjt(); return false;" class="btn_big"><img src="/images/img/ico_magnifier.png">검색</a></div>
								</div>
							</form>
						</div>
						<!---search//---->
						...
						<div class="row">
							<div class="tb_wrap" style="border: solid 1px #D7D7D7;">
								...
								<table id="recDylyAdjtLst"></table>
								<div id="recDylyAdjtLstPager"></div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					setJqGridForm('recDylyAdjtLst', 'recDylyAdjtLstPager', colNames, colModel, '');
					
					/* jqGrid Group Header define */
					jQuery("#recDylyAdjtLst").jqGrid('setGroupHeaders', {
					...
					/* 좌측메뉴 재구성 */
					makeLeftMenuList('adjustment', 9, 3);
