 ...
 *      수정일                                       수정자                                                  수정내용
 *  -------------        -----------       -------------------------
 *  2016. 11. 3.          creme55          최초생성(전력 정산통계 조회)
 *
 * </pre>
 **/
%>
...
<body>
					...
					<div class="contents">
						<div class="title">전력 정산 통계
							<div class="location">
								...
								<img src="/images/img/ico_arr.png"><a href="javascript:;" onclick="javascript:goPwrAdjtSttcInfoList(); return false;">전력 정산 통계</a></div>
						</div>
						
						<!---//search---->
						<div class="select_wrap">
							<form name="pwrAdjtSttcLstFrm" id="pwrAdjtSttcLstFrm" method="POST" enctype="multipart/form-data" action="">
								<div class="form-group">
									...
									<div class="bn"><a href="javascript:;" onclick="javascript:searchPwrAdjtSttc(); return false;" class="btn_big"><img src="/images/img/ico_magnifier.png">검색</a></div>
								</div>
							</form>
						</div>
						<!---search//---->
						...
						<!---//button---->
						<div class="rgbn_wrap">
							<a href="javascript:;" onclick="javascript:pwrAdjtSttcGraphPopup('pwrAdjtSttcDialog', 'open'); return false;" class="btn_big2"><img src="/images/img/ico_graph.png">그래프</a><a href="javascript:;" onclick="javascript:adjustmentTemplateDown(); return false;" class="btn_big2"><img src="/images/img/ico_excel.png">다운로드</a>
						</div>
						<!---button//---->
						...
						<div class="row">
							<div class="tb_wrap" style="border: solid 1px #D7D7D7;">
								...
								<table id="pwrAdjtSttcLst"></table>
								<div id="pwrAdjtSttcLstPager"></div>
				...
				<!-- 레이어 팝업 : 전력정산통계  -->
				<div id="pwrAdjtSttcDialog" class="popUp" style="display:none;" title="전력정산통계">
					<!----//wrapper----->
					<div class="pop_wrap">
						...
						<div class="pop_contain">
							<!---//search---->
							<div class="select_wrap">
								<form name="pwrAdjtSttcPopUp" id="pwrAdjtSttcPopUp" method="post" encType="multipart/form-data" action="">
									<div class="form-group">
										<table class="tb4">
										<tr>
											<th>
							...
							<!---//button---->
							<div class="rgbn_wrap">
								<a href="javascript:;" onclick="javascript:searchPwrAdjtSttcGraph(); return false;" class="btn_big"><img src="/images/img/ico_magnifier.png">검색</a>
							</div>
							<!---button//---->
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					setJqGridForm('pwrAdjtSttcLst', 'pwrAdjtSttcLstPager', colNames, colModel, '');
					
					/* jqGrid Group Header define */
					jQuery("#pwrAdjtSttcLst").jqGrid('setGroupHeaders', {
					...
					/* dislog popup 정의 */
					openDialogPopUp('pwrAdjtSttcDialog', '890');
					
					/* 좌측메뉴 재구성 */
					makeLeftMenuList('adjustment', 9, 5);
