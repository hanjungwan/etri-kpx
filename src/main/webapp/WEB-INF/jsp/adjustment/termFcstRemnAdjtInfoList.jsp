 ...
 *      수정일                                       수정자                                                  수정내용
 *  -------------        -----------       -------------------------
 *  2016. 11. 3.          creme55          최초생성(기간 예측제고량 정삱 조회)
 *
 * </pre>
 **/
%>
...
<body>
					...
					<div class="contents">
						<div class="title">기간 예측제고량 정산
							<div class="location">
								...
								<img src="/images/img/ico_arr.png"><a href="javascript:;" onclick="javascript:goTermFcstRemmAdjtInfoList(); return false;">기간 예측제고량 정산</a></div>
						</div>
						
						<!---//search---->
						<div class="select_wrap">
							<form name="termFcstRemmAdjtLstFrm" id="termFcstRemmAdjtLstFrm" method="POST" enctype="multipart/form-data" action="">
								<div class="form-group">
									...
									<div class="bn"><a href="javascript:;" onclick="javascript:searchTermFcstRemmAdjt(); return false;" class="btn_big"><img src="/images/img/ico_magnifier.png">검색</a></div>
								</div>
							</form>
						</div>
						<!---search//---->
						...
						<div class="row">
							<div class="tb_wrap" style="border: solid 1px #D7D7D7;">
								...
								<table id="termFcstRemmAdjtLst"></table>
								<div id="termFcstRemmAdjtLstPager"></div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					setJqGridForm('termFcstRemmAdjtLst', 'termFcstRemmAdjtLstPager', colNames, colModel, '');
					...
					/* 좌측메뉴 재구성 */
					makeLeftMenuList('adjustment', 9, 12);
