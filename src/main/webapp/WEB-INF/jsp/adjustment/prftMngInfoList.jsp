 ...
 *      수정일                                       수정자                                                  수정내용
 *  -------------        -----------       -------------------------
 *  2016. 11. 3.          creme55          최초생성(수익관리 조회)
 *
 * </pre>
 **/
%>
...
<body>
					...
					<div class="contents">
						<div class="title">수익관리
							<div class="location">
								...
								<img src="/images/img/ico_arr.png"><a href="javascript:;" onclick="javascript:goPrftMngInfoList(); return false;">수익관리</a></div>
						</div>
						
						<!---//search---->
						<div class="select_wrap">
							<form name="prftMngLstFrm" id="prftMngLstFrm" method="POST" enctype="multipart/form-data" action="">
						...
						<div class="row">
							<div class="tb_wrap" style="border: solid 1px #D7D7D7;">
								...
								<table id="prftMngtLst"></table>
								<div id="prftMngLstPager"></div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					setJqGridForm('prftMngtLst', 'prftMngLstPager', colNames, colModel, '');
					...
					/* 좌측메뉴 재구성 */
					makeLeftMenuList('adjustment', 9, 13);
