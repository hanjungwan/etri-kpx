...
public interface CommonService {
	 ...
	 * 
	 */
	public Map<?, ?> uploadFileProcess(final HttpServletRequest request) throws Exception;
	...
	public List<?> getDataList(String sqlId,Map<String, Object> paramMap) throws Exception;
}