 ...
 *      수정일                                       수정자                                                  수정내용
 *  -------------        -----------       -------------------------
 *  2016. 11. 2.          creme55          최초 생성 (전력입찰통계 조회)
 *
 * </pre>
 **/
%>
...
<body>
					...
					<div class="contents" >
						<div class="title">전력 입찰 통계
							<div class="location">
								...
								<img src="/images/img/ico_arr.png"><a href="javascript:;" onclick="javascript:goPwrSleTndrSttcGraphInfoList(); return false;">전력 입찰 통계</a></div>
						</div>
						
						<!---//search---->
						<div class="select_wrap">
							<form name="pwrSleTndrSttcLstFrm" id="pwrSleTndrSttcLstFrm" method="POST" enctype="multipart/form-data" action="">
								<div class="form-group">
									...
									<tr>
										...
										<td>
											<select name="setGnrTp" id="setGnrTp" style="width:130px">
												<option>전체</option>
											</select>
										</td>
										<th>
						...
						<!---//button---->
						<div class="rgbn_wrap">
							<a href="javascript:;" onclick="javascript:pwrSleTndrGrphPopup('pwrSleTndrDspDialog', 'open'); return false;" class="btn_big2"><img src="/images/img/ico_graph.png">그래프</a> <a href="javascript:;" onclick="javascript:tenderTemplateDown(); return false;" class="btn_big2"><img src="/images/img/ico_excel.png">다운로드</a>
						</div>
						<!---button//---->
						...
						<div class="row">
							<div class="tb_wrap" style="border: solid 1px #D7D7D7;">
								...
								<table id="pwrSleTndrSttcLst"></table>
								<div id="pwrSleTndrSttcLstPager"></div>
				...
				<!-- 레이어 팝업 : 전력입찰통계  -->
				<div id="pwrSleTndrDspDialog" class="popUp" style="display:none;" title="전력입찰통계">
					<!----//wrapper----->
					<div class="pop_wrap">
						...
						<div class="pop_contain">
							<!---//search---->
							<div class="select_wrap">
								<form name="pwrSleTndrDspPopUp" id="pwrSleTndrDspPopUp" method="post" encType="multipart/form-data" action="">
									<div class="form-group">
										<table class="tb4">
										<tr>
											<th>
							...
							<!---//button---->
							<div class="rgbn_wrap">
								<a href="javascript:;" onclick="javascript:searchPwrSleTndrSttcGraph(); return false;" class="btn_big"><img src="/images/img/ico_magnifier.png">검색</a>
							</div>
							<!---button//---->
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					setJqGridForm('pwrSleTndrSttcLst', 'pwrSleTndrSttcLstPager', colNames, colModel, '');
					
					/* jqGrid Group Header define */
					jQuery("#pwrSleTndrSttcLst").jqGrid('setGroupHeaders', {
					...
					/* dislog popup 정의 */
					openDialogPopUp('pwrSleTndrDspDialog', '890');
					
					/* 좌측메뉴 재구성 */
					makeLeftMenuList('tender', 5, 3);
